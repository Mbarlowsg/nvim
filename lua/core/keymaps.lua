...
keymap.set("v", "J", ":m '>+1<CR>gv=gv") -- move line down in visual mode
keymap.set("v", "K", ":m '<-2<CR>gv=gv") -- move line up in visual mode
...
keymap.set('n', '<leader>ff', require('telescope.builtin').current_buffer_fuzzy_find, {})
